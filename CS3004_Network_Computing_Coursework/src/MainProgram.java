...
public class MainProgram {
	...
	public static void main(String[] args) {
		...
		WindowLogger.log(TAG + " - Automated Client Application started at: " + timestamp, Process.CLIENT);
		// Randomly select a client and trigger a transaction
		randomSelector();
		// Trigger a particular client and a random transaction.
	...
	private static synchronized void randomBankClientInitiator(int i) {
		...
		WindowLogger.log(message, Process.CLIENT);
	}
