...
public class BankClientThread extends Thread {
    ...
    public void run() {
        try {
            ...
            /*
             * Print out what the server says then take what the client's response and
             * send it back to the server.
             */
            // Make the client's internal communication state object
            BankClientState bankClientState = new BankClientState(BankClientID, TransactionID, TransactionAmount, TransferClientID);
